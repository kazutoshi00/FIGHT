...
#define WINDOW_NAME		_T("AT13C222 15 柴田和俊")	// ウインドウのキャプション名
...
HRESULT Init(HWND hWnd, BOOL bWindow)
{
	...
	CSound::Play(SOUND_LABEL_BGM_0);
	CSound::SetVolume(SOUND_LABEL_BGM_0, 0.3f);
